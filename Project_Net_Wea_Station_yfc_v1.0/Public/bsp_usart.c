...
void USART_Config(void)
{
	...
	// 打开串口GPIO的时钟
	DEBUG_USART_APBxClkCmd(DEBUG_USART_GPIO_CLK, ENABLE);//打开GPIOA时钟
	
	// 打开串口外设的时钟
	DEBUG_USART_GPIO_APBxClkCmd(DEBUG_USART_CLK, ENABLE);//打开USART1时钟
  ...
  // 将USART Rx的GPIO配置为浮空输入模式
	...
	USART_HardwareFlowControl_None;//不启用
	// 配置工作模式，收发一起
